...
class LocalDataSource {
  ...
  Future<List<ListingDraft>> getDrafts() async => Hive.box<ListingDraft>(HiveBoxes.drafts).values.toList();

  Future<void> saveDraft(ListingDraft draft) async => Hive.box<ListingDraft>(HiveBoxes.drafts).put(draft.id, draft);

  Future<void> deleteDraft(String id) async => Hive.box<ListingDraft>(HiveBoxes.drafts).delete(id);
  ...
  Future<void> clearAll() async {
    await Future.wait([
      ...
      Hive.box<ListingDraft>(HiveBoxes.drafts).clear(),
